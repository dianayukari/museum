...
<div class="content-container">
    ...
    <p><strong>The Social Museum</strong> explores how people interact with artworks in photos shared on Instagram, uncovering the performative side of museum visits. Are visitors truly engaging with the art, or are they performing in front of the camera to have a curated presence for social media? What defines engagement in this context?</p>
    ...
    <p>The website also serves as a comprehensive repository of our research data. It contains all 2,251 photos of people in gallery settings that we analyzed, along with filters for each pose category we identified (side, back, front, sitting, and other). This allows visitors to explore the full dataset and observe the patterns we discovered in our study.</p>
    
    <p>Additionally, we included this detailed description of our research protocol, outlining the methodologies we employed. This transparency in our research process enables visitors to understand the rigor behind our findings and potentially inspire further investigations into the intersection of social media and museum experiences.</p>
    
    <p>This interactive approach allows visitors to engage with our research findings and also to become active participants in the ongoing dialogue about social media's impact on museum experiences. By seeing themselves reflected in the context of our study, visitors are encouraged to critically examine their own behaviors and motivations when interacting with art in public spaces.</p>
    
</div>

<footer>
    <hr>
    <p class="footer">2025 Project for the Design Academy Eindhoven. <br> Tutored by Studio Calibro</p>
</footer>
